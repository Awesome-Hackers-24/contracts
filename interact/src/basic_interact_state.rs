...
pub type BrainNftsContract = ContractInfo<brain_nfts::Proxy<StaticApi>>;
...
impl State {
    ...
    pub fn adder(&self) -> BrainNftsContract {
        BrainNftsContract::new(
            self.adder_address
                .clone()
    ...
    pub fn default_adder(&self) -> BrainNftsContract {
        BrainNftsContract::new(DEFAULT_ADDER_ADDRESS)
    }
}
