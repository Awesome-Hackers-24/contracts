...
async fn main() {
    ...
    let mut basic_interact = BrainNftsInteract::init().await;
...
impl BrainNftsInteract {
    async fn init() -> Self {
        ...
        let adder_code = BytesValue::interpret_from(
            "mxsc:../output/brain-nfts.mxsc.json",
