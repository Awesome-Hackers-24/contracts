...
const ADDER_PATH_EXPR: &str = "mxsc:output/brain-nfts.mxsc.json";

fn world() -> ScenarioWorld {
    let mut blockchain = ScenarioWorld::new();
    // blockchain.set_current_dir_from_workspace("relative path to your workspace, if applicable");

    blockchain.register_contract(ADDER_PATH_EXPR, brain_nfts::ContractBuilder);
    blockchain
}
...
fn adder_blackbox_with_values() {
    ...
    let mut adder_contract = ContractInfo::<brain_nfts::Proxy<StaticApi>>::new("sc:adder");
